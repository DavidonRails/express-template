...
function hubspotSubmit(fields, recaptcha_score, ip_address) {
  ...
  if(budget!==null && budget!=='' && typeof(budget) !== 'undefined') fields.push({name: 'availabile_budget', value: budget });
  if(budget!==null && budget!=='' && typeof(budget) !== 'undefined') fields.push({name: 'Budget', value: budget });
  if(budget!==null && budget!=='' && typeof(budget) !== 'undefined') fields.push({name: 'Client Budget', value: budget });
  if(timeframe!==null && timeframe!=='' && typeof(timeframe) !== 'undefined') fields.push({name: 'Timeframe', value: timeframe });
  ...
  if(budget!==null && budget!=='' && typeof(budget) !== 'undefined') console.log('fields passed');
  ...
  .catch(error => {
    console.log('error posting to hs');
    console.log(error);
  });
...
app.get('/our-work/clyn', function(req, res) {
  res.render('case-studies/clyn.jade', {
    title: 'Client Case Studies'
  });
});

app.get('/our-work/evocai', function(req, res) {
  res.render('case-studies/evocai.jade', {
    title: 'Client Case Studies'
  });
});

app.get('/our-work/gravy', function(req, res) {
  res.render('case-studies/gravy.jade', {
    title: 'Client Case Studies'
  });
});
